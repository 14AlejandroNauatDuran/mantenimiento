<?php
                                switch ($_SESSION['rol_id']) {
                                    case '1':
                                        $res = $MySQLiconn->query("SELECT orden_trabajo.id,orden_solicitud.orden_descripcion,orden_solicitud.orden_fecha,
                                        ...
                                        orden_trabajo.hora_inicio,orden_trabajo.hora_fin,orden_trabajo.ejecutantes,b.persona_nombres as entrega_tra
                                                FROM orden_trabajo
                                                    ...
                                                    INNER JOIN estado
                                                        ON orden_solicitud.estado_id = estado.id where estado_id =3");
                                        break;
                                    case '2':
                                                ...
                                                switch ($_SESSION['persona_usuario']) {
                                                    ...
                                                    case 'ROROZCO':
                                                        ...
                                                        orden_trabajo.hora_inicio,orden_trabajo.hora_fin,orden_trabajo.ejecutantes,b.persona_nombres as entrega_tra
                                                                FROM orden_trabajo
                                                                    ...
                                                                    ON orden_trabajo.persona_id = b.id
                                                                    INNER JOIN estado
                                                                        ON orden_solicitud.estado_id = estado.id where estado_id =3 and departamento.id in (4,9) ");
                                                        break;
                                                    default:
                                                    $res = $MySQLiconn->query("SELECT orden_trabajo.id,orden_solicitud.orden_descripcion,orden_solicitud.orden_fecha,
                                                    orden_solicitud.orden_hora, departamento.departamento_nombre as area_mante, equipo.equipo_nombre, estado.estado_tipo, 
                                                    ...
                                                    orden_trabajo.hora_inicio,orden_trabajo.hora_fin,orden_trabajo.ejecutantes,b.persona_nombres as entrega_tra
                                                            FROM orden_trabajo
                                                                ...
                                                                ON orden_trabajo.persona_id = b.id
                                                                INNER JOIN estado
                                                                    ON orden_solicitud.estado_id = estado.id where estado_id =3 and departamento.id = 4");
                                                        break;
                                                }
                                            ...
                                            case '7':
                                                ...
                                                orden_trabajo.hora_inicio,orden_trabajo.hora_fin,orden_trabajo.ejecutantes,b.persona_nombres as entrega_tra
                                                        FROM orden_trabajo
                                                            ...
                                                            ON orden_trabajo.persona_id = b.id
                                                            INNER JOIN estado
                                                                ON orden_solicitud.estado_id = estado.id where estado_id =3 and departamento.id =9");
                                                break;
                                            case '3':
                                                $res = $MySQLiconn->query("SELECT orden_trabajo.id,orden_solicitud.orden_descripcion,orden_solicitud.orden_fecha,
                                                orden_solicitud.orden_hora, departamento.departamento_nombre as area_mante, equipo.equipo_nombre, estado.estado_tipo, 
                                                ...
                                                orden_trabajo.hora_inicio,orden_trabajo.hora_fin,orden_trabajo.ejecutantes,b.persona_nombres as entrega_tra
                                                        FROM orden_trabajo
                                                            ...
                                                            ON orden_trabajo.persona_id = b.id
                                                            INNER JOIN estado
                                                                ON orden_solicitud.estado_id = estado.id where estado_id =3 and departamentoB.id =3");
                                                break;
                                            default:
                                                # code...
                                                break;
