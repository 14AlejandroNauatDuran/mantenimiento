                                    ...
                                    case '1':
                                        $res = $MySQLiconn->query("SELECT orden_solicitud.id,orden_solicitud.estado_id,orden_solicitud.orden_descripcion,orden_solicitud.orden_fecha,orden_solicitud.orden_hora, departamento.departamento_nombre as area_mante, equipo.equipo_nombre, estado.estado_tipo, persona.persona_nombres, departamentoB.departamento_nombre as depto_so
                                                FROM orden_solicitud
                                                    ...
                                                    INNER JOIN estado
                                                        ON orden_solicitud.estado_id = estado.id where estado_id =1");
                                        break;
                                    case '2':
                                                    ...
                                                    case 'EMONTERO':
                                                        ...
                                                        FROM orden_solicitud
                                                            ...
                                                            INNER JOIN persona
                                                                ...
                                                                ON persona.departamento_id = departamentoB.id
                                                            INNER JOIN estado
                                                                ON orden_solicitud.estado_id = estado.id where estado_id =1 and departamento.id in(4,9)");
                                                        break;
                                                    default:
                                                        $res = $MySQLiconn->query("SELECT orden_solicitud.id,orden_solicitud.estado_id,orden_solicitud.orden_descripcion,orden_solicitud.orden_fecha,orden_solicitud.orden_hora, departamento.departamento_nombre as area_mante, equipo.equipo_nombre, estado.estado_tipo, persona.persona_nombres, departamentoB.departamento_nombre as depto_so
                                                    FROM orden_solicitud
                                                        ...
                                                        INNER JOIN persona
                                                            ...
                                                            ON persona.departamento_id = departamentoB.id
                                                        INNER JOIN estado
                                                            ON orden_solicitud.estado_id = estado.id where estado_id =1 and departamento.id =4");
                                                        break;
                                                }
                                                ...
                                                $res = $MySQLiconn->query("SELECT orden_solicitud.id,orden_solicitud.estado_id,orden_solicitud.orden_descripcion,orden_solicitud.orden_fecha,orden_solicitud.orden_hora, departamento.departamento_nombre as area_mante, equipo.equipo_nombre, estado.estado_tipo, persona.persona_nombres, departamentoB.departamento_nombre as depto_so
                                                    FROM orden_solicitud
                                                        ...
                                                        INNER JOIN persona
                                                            ...
                                                            ON persona.departamento_id = departamentoB.id
                                                        INNER JOIN estado
                                                            ON orden_solicitud.estado_id = estado.id where estado_id =1 and departamento.id =9");
                                                break;
                                            case '3':
                                                $res = $MySQLiconn->query("SELECT orden_solicitud.id,orden_solicitud.estado_id,orden_solicitud.orden_descripcion,orden_solicitud.orden_fecha,orden_solicitud.orden_hora, departamento.departamento_nombre as area_mante, equipo.equipo_nombre, estado.estado_tipo, persona.persona_nombres, departamentoB.departamento_nombre as depto_so
                                                    FROM orden_solicitud
                                                        ...
                                                        INNER JOIN persona
                                                            ...
                                                            ON persona.departamento_id = departamentoB.id
                                                        INNER JOIN estado
                                                            ON orden_solicitud.estado_id = estado.id where estado_id =1 and departamentoB.id =3 ");
                                                break;
                                            default:
                                                # code...
                                                break;
